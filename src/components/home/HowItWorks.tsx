...
const colorMap: Record<string, { step: string; icon: string; bg: string; line: string }> = {
  blue: { step: "text-brand-blue", icon: "text-brand-blue", bg: "bg-blue-50", line: "border-brand-blue/30" },
  purple: { step: "text-brand-purple", icon: "text-brand-purple", bg: "bg-purple-50", line: "border-brand-purple/30" },
  cyan: { step: "text-brand-cyan", icon: "text-brand-cyan", bg: "bg-cyan-50", line: "border-brand-cyan/30" },
};
    ...
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-brand-blue via-brand-purple to-brand-cyan opacity-20" />
              ...
              return (
                <div key={step.step} className="flex flex-col items-center text-center group">
                  ...
                  <div className="relative mb-6">
                    ...
                    <span className={`absolute -top-2 -right-2 text-xs font-bold ${colors.step} bg-white rounded-full w-6 h-6 flex items-center justify-center shadow-sm border border-gray-100`}>
                      {index + 1}
                    </span>
                  </div>
