  ...
  try {
    ...
    const course = await prisma.course.create({
      data: {
        ...
        privatePricePerSession:    privatePricePerSession    ?? 0,
  ...
  try {
    ...
    const updated = await prisma.course.update({
      ...
      data: {
        ...
        ...(originalPrice              !== undefined && { originalPrice: originalPrice || 0 }),
        ...(originalPriceUSD           !== undefined && { originalPriceUSD: originalPriceUSD || 0 }),
        ...(pricePerSession            !== undefined && { pricePerSession: pricePerSession || 0 }),
        ...(privatePricePerSession     !== undefined && { privatePricePerSession: privatePricePerSession || 0 }),
